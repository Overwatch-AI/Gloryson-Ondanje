...
class PDFParser:
    ...
    def parse(self) -> List[ParsedElement]:
        ...
        for elem in elements:
            ...
            page_num = elem.metadata.page_number if hasattr(elem.metadata, 'page_number') else 1
        ...
        logger.info(f"Parsed {len(parsed)} elements from {len(set(e.page_number for e in parsed))} pages")
        return parsed
